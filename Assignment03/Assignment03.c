...
/*                                                    */
/* DESCRIPTION:                                       */
/* This program will prompt user for number of hours  */ 
/* worekd per week by each employee, whose pay will   */ 
/* then be calculated using a 'for' loop.             */
/*                                                    */
/* Conditional expressions are utilized to determine  */
/* appropriate overtime compensation for each worker. */
/*                                                    */
/* Program uses arrays to store employee data and to  */ 
/* compute totals and averages for each data heading. */
/*----------------------------------------------------*/
